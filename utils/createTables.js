const init = async () => {
  ...
  DROP TABLE user_incidence cascade;
  DROP TABLE device_component cascade;
  DROP TABLE device_error cascade;
  DROP TABLE incidence_error cascade;
  DROP TABLE technician_error cascade;
  ...
  ALTER TABLE "device_component" ADD CONSTRAINT "device_component_device_id" FOREIGN KEY ("device_id") REFERENCES "devices" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
  ...
  ALTER TABLE "technician_error" ADD CONSTRAINT "technician_error_error_id" FOREIGN KEY ("error_id") REFERENCES "errors" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE "technician_error" ADD CONSTRAINT "technician_error_technician_id" FOREIGN KEY ("technician_id") REFERENCES "technicians" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
