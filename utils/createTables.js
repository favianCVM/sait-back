const init = async () => {
  ...
  DROP TABLE device_errors cascade;
  ...
  ALTER TABLE "device_errors" ADD CONSTRAINT "device_errors_device_id" FOREIGN KEY ("device_id") REFERENCES "devices" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE "device_errors" ADD CONSTRAINT "device_errors_error_id" FOREIGN KEY ("error_id") REFERENCES "errors" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
